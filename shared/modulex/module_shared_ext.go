...
// generated at: 2026-07-10 00:27:19 CST
...
func SameTenantDomain(left, right *uint32) bool {
	leftPlatform := left == nil || *left == PlatformTenantID
	rightPlatform := right == nil || *right == PlatformTenantID
