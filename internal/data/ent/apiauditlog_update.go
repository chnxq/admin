...
func (_u *ApiAuditLogUpdate) SetGeoLocation(v *audit.GeoLocation) *ApiAuditLogUpdate {
...
func (_u *ApiAuditLogUpdate) SetDeviceInfo(v *audit.DeviceInfo) *ApiAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *ApiAuditLogUpdateOne) SetGeoLocation(v *audit.GeoLocation) *ApiAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *ApiAuditLogUpdateOne) SetDeviceInfo(v *audit.DeviceInfo) *ApiAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
