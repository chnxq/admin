...
func (_u *DataAccessAuditLogUpdate) SetGeoLocation(v *audit.GeoLocation) *DataAccessAuditLogUpdate {
...
func (_u *DataAccessAuditLogUpdate) SetDeviceInfo(v *audit.DeviceInfo) *DataAccessAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *DataAccessAuditLogUpdateOne) SetGeoLocation(v *audit.GeoLocation) *DataAccessAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *DataAccessAuditLogUpdateOne) SetDeviceInfo(v *audit.DeviceInfo) *DataAccessAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
