...
func (_c *MenuCreate) SetMeta(v *resource.MenuMeta) *MenuCreate {
...
// SetMeta sets the "meta" field.
func (u *MenuUpsert) SetMeta(v *resource.MenuMeta) *MenuUpsert {
...
// SetMeta sets the "meta" field.
func (u *MenuUpsertOne) SetMeta(v *resource.MenuMeta) *MenuUpsertOne {
	return u.Update(func(s *MenuUpsert) {
		s.SetMeta(v)
	})
}
...
// SetMeta sets the "meta" field.
func (u *MenuUpsertBulk) SetMeta(v *resource.MenuMeta) *MenuUpsertBulk {
	return u.Update(func(s *MenuUpsert) {
		s.SetMeta(v)
	})
}
