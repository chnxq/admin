...
func (_u *RoleMetadataUpdate) SetCustomOverrides(v *permissionv1.RoleOverride) *RoleMetadataUpdate {
...
// SetCustomOverrides sets the "custom_overrides" field.
func (_u *RoleMetadataUpdateOne) SetCustomOverrides(v *permissionv1.RoleOverride) *RoleMetadataUpdateOne {
	_u.mutation.SetCustomOverrides(v)
	return _u
}
