...
func (_u *LoginAuditLogUpdate) SetGeoLocation(v *audit.GeoLocation) *LoginAuditLogUpdate {
...
func (_u *LoginAuditLogUpdate) SetDeviceInfo(v *audit.DeviceInfo) *LoginAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *LoginAuditLogUpdateOne) SetGeoLocation(v *audit.GeoLocation) *LoginAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *LoginAuditLogUpdateOne) SetDeviceInfo(v *audit.DeviceInfo) *LoginAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
