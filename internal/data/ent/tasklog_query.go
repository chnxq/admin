...
func (_q *TaskLogQuery) prepareQuery(ctx context.Context) error {
	...
	if tasklog.Policy == nil {
		return errors.New("ent: uninitialized tasklog.Policy (forgotten import ent/runtime?)")
	}
	if err := tasklog.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
