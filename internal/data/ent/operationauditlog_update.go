...
func (_u *OperationAuditLogUpdate) SetGeoLocation(v *audit.GeoLocation) *OperationAuditLogUpdate {
...
func (_u *OperationAuditLogUpdate) SetDeviceInfo(v *audit.DeviceInfo) *OperationAuditLogUpdate {
...
// SetGeoLocation sets the "geo_location" field.
func (_u *OperationAuditLogUpdateOne) SetGeoLocation(v *audit.GeoLocation) *OperationAuditLogUpdateOne {
	_u.mutation.SetGeoLocation(v)
	return _u
}
...
// SetDeviceInfo sets the "device_info" field.
func (_u *OperationAuditLogUpdateOne) SetDeviceInfo(v *audit.DeviceInfo) *OperationAuditLogUpdateOne {
	_u.mutation.SetDeviceInfo(v)
	return _u
}
