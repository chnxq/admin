...
// 	protoc        (unknown)
// source: authentication/v1/operator.proto

package authentication

import (
	v1 "admin/api/gen/identity/v1"
...
func (OperatorMetadata_OperatorType) Descriptor() protoreflect.EnumDescriptor {
	return file_authentication_v1_operator_proto_enumTypes[0].Descriptor()
}

func (OperatorMetadata_OperatorType) Type() protoreflect.EnumType {
	return &file_authentication_v1_operator_proto_enumTypes[0]
}
...
func (OperatorMetadata_OperatorType) EnumDescriptor() ([]byte, []int) {
	return file_authentication_v1_operator_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OperatorMetadata) Reset() {
	*x = OperatorMetadata{}
	mi := &file_authentication_v1_operator_proto_msgTypes[0]
...
func (*OperatorMetadata) Descriptor() ([]byte, []int) {
	return file_authentication_v1_operator_proto_rawDescGZIP(), []int{0}
}
...
func (x *SignedOperatorPayload) Reset() {
	*x = SignedOperatorPayload{}
	mi := &file_authentication_v1_operator_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignedOperatorPayload) Descriptor() ([]byte, []int) {
	return file_authentication_v1_operator_proto_rawDescGZIP(), []int{1}
}
...
var File_authentication_v1_operator_proto protoreflect.FileDescriptor

const file_authentication_v1_operator_proto_rawDesc = "" +
	"\n" +
	" authentication/v1/operator.proto\x12\x19authentication.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17identity/v1/types.proto\"\x82\x05\n" +
	...
	"\tsignature\x18\x02 \x01(\fR\tsignatureB\xe4\x01\n" +
	"\x1dcom.authentication.service.v1B\rOperatorProtoP\x01Z.admin/api/gen/authentication/v1;authentication\xa2\x02\x03ASX\xaa\x02\x19Authentication.Service.V1\xca\x02\x19Authentication\\Service\\V1\xe2\x02%Authentication\\Service\\V1\\GPBMetadata\xea\x02\x1bAuthentication::Service::V1b\x06proto3"

var (
	file_authentication_v1_operator_proto_rawDescOnce sync.Once
	file_authentication_v1_operator_proto_rawDescData []byte
)

func file_authentication_v1_operator_proto_rawDescGZIP() []byte {
	file_authentication_v1_operator_proto_rawDescOnce.Do(func() {
		file_authentication_v1_operator_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_authentication_v1_operator_proto_rawDesc), len(file_authentication_v1_operator_proto_rawDesc)))
	})
	return file_authentication_v1_operator_proto_rawDescData
}

var file_authentication_v1_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_authentication_v1_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_authentication_v1_operator_proto_goTypes = []any{
...
var file_authentication_v1_operator_proto_depIdxs = []int32{
...
func init() { file_authentication_v1_operator_proto_init() }
func file_authentication_v1_operator_proto_init() {
	if File_authentication_v1_operator_proto != nil {
		return
	}
	file_authentication_v1_operator_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authentication_v1_operator_proto_rawDesc), len(file_authentication_v1_operator_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_authentication_v1_operator_proto_goTypes,
		DependencyIndexes: file_authentication_v1_operator_proto_depIdxs,
		EnumInfos:         file_authentication_v1_operator_proto_enumTypes,
		MessageInfos:      file_authentication_v1_operator_proto_msgTypes,
	}.Build()
	File_authentication_v1_operator_proto = out.File
	file_authentication_v1_operator_proto_goTypes = nil
	file_authentication_v1_operator_proto_depIdxs = nil
}
