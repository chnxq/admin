...
func (x *UserTokenPayload) Reset() {
	*x = UserTokenPayload{}
	mi := &file_authentication_v1_user_token_proto_msgTypes[0]
...
func (*UserTokenPayload) Descriptor() ([]byte, []int) {
	return file_authentication_v1_user_token_proto_rawDescGZIP(), []int{0}
}
...
var File_authentication_v1_user_token_proto protoreflect.FileDescriptor

const file_authentication_v1_user_token_proto_rawDesc = "" +
	"\n" +
	"\"authentication/v1/user_token.proto\x12\x19authentication.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17identity/v1/types.proto\"\xfc\x05\n" +
	...
	"\x04_jtiB\xe5\x01\n" +
	"\x1dcom.authentication.service.v1B\x0eUserTokenProtoP\x01Z.admin/api/gen/authentication/v1;authentication\xa2\x02\x03ASX\xaa\x02\x19Authentication.Service.V1\xca\x02\x19Authentication\\Service\\V1\xe2\x02%Authentication\\Service\\V1\\GPBMetadata\xea\x02\x1bAuthentication::Service::V1b\x06proto3"

var (
	file_authentication_v1_user_token_proto_rawDescOnce sync.Once
	file_authentication_v1_user_token_proto_rawDescData []byte
)

func file_authentication_v1_user_token_proto_rawDescGZIP() []byte {
	file_authentication_v1_user_token_proto_rawDescOnce.Do(func() {
		file_authentication_v1_user_token_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_authentication_v1_user_token_proto_rawDesc), len(file_authentication_v1_user_token_proto_rawDesc)))
	})
	return file_authentication_v1_user_token_proto_rawDescData
}

var file_authentication_v1_user_token_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_authentication_v1_user_token_proto_goTypes = []any{
	(*UserTokenPayload)(nil), // 0: authentication.service.v1.UserTokenPayload
	(v1.DataScope)(0),        // 1: identity.service.v1.DataScope
}
var file_authentication_v1_user_token_proto_depIdxs = []int32{
...
func init() { file_authentication_v1_user_token_proto_init() }
func file_authentication_v1_user_token_proto_init() {
	if File_authentication_v1_user_token_proto != nil {
		return
	}
	file_authentication_v1_user_token_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_authentication_v1_user_token_proto_rawDesc), len(file_authentication_v1_user_token_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_authentication_v1_user_token_proto_goTypes,
		DependencyIndexes: file_authentication_v1_user_token_proto_depIdxs,
		MessageInfos:      file_authentication_v1_user_token_proto_msgTypes,
	}.Build()
	File_authentication_v1_user_token_proto = out.File
	file_authentication_v1_user_token_proto_goTypes = nil
	file_authentication_v1_user_token_proto_depIdxs = nil
}
