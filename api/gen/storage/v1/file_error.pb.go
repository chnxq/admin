...
// 	protoc        (unknown)
// source: storage/v1/file_error.proto
...
func (StorageErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_storage_v1_file_error_proto_enumTypes[0].Descriptor()
}

func (StorageErrorReason) Type() protoreflect.EnumType {
	return &file_storage_v1_file_error_proto_enumTypes[0]
}
...
func (StorageErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_storage_v1_file_error_proto_rawDescGZIP(), []int{0}
}

var File_storage_v1_file_error_proto protoreflect.FileDescriptor

const file_storage_v1_file_error_proto_rawDesc = "" +
	"\n" +
	"\x1bstorage/v1/file_error.proto\x12\x12storage.service.v1\x1a\x16errors/v1/errors.proto*\x96\v\n" +
	...
	"\x16com.storage.service.v1B\x0eFileErrorProtoP\x01Z admin/api/gen/storage/v1;storage\xa2\x02\x03SSX\xaa\x02\x12Storage.Service.V1\xca\x02\x12Storage\\Service\\V1\xe2\x02\x1eStorage\\Service\\V1\\GPBMetadata\xea\x02\x14Storage::Service::V1b\x06proto3"

var (
	file_storage_v1_file_error_proto_rawDescOnce sync.Once
	file_storage_v1_file_error_proto_rawDescData []byte
)

func file_storage_v1_file_error_proto_rawDescGZIP() []byte {
	file_storage_v1_file_error_proto_rawDescOnce.Do(func() {
		file_storage_v1_file_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_v1_file_error_proto_rawDesc), len(file_storage_v1_file_error_proto_rawDesc)))
	})
	return file_storage_v1_file_error_proto_rawDescData
}

var file_storage_v1_file_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_storage_v1_file_error_proto_goTypes = []any{
	(StorageErrorReason)(0), // 0: storage.service.v1.StorageErrorReason
}
var file_storage_v1_file_error_proto_depIdxs = []int32{
...
func init() { file_storage_v1_file_error_proto_init() }
func file_storage_v1_file_error_proto_init() {
	if File_storage_v1_file_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_storage_v1_file_error_proto_rawDesc), len(file_storage_v1_file_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_storage_v1_file_error_proto_goTypes,
		DependencyIndexes: file_storage_v1_file_error_proto_depIdxs,
		EnumInfos:         file_storage_v1_file_error_proto_enumTypes,
	}.Build()
	File_storage_v1_file_error_proto = out.File
	file_storage_v1_file_error_proto_goTypes = nil
	file_storage_v1_file_error_proto_depIdxs = nil
}
