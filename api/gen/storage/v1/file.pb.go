...
func (OSSProvider) Descriptor() protoreflect.EnumDescriptor {
	return file_storage_v1_file_proto_enumTypes[0].Descriptor()
}

func (OSSProvider) Type() protoreflect.EnumType {
	return &file_storage_v1_file_proto_enumTypes[0]
}
...
const file_storage_v1_file_proto_rawDesc = "" +
	"\n" +
	"\x15storage/v1/file.proto\x12\x12storage.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\x90\x0e\n" +
	"\x04File\x12&\n" +
	...
	"\x06Delete\x12%.storage.service.v1.DeleteFileRequest\x1a\x16.google.protobuf.Empty\"\x00B\xaf\x01\n" +
	"\x16com.storage.service.v1B\tFileProtoP\x01Z admin/api/gen/storage/v1;storage\xa2\x02\x03SSX\xaa\x02\x12Storage.Service.V1\xca\x02\x12Storage\\Service\\V1\xe2\x02\x1eStorage\\Service\\V1\\GPBMetadata\xea\x02\x14Storage::Service::V1b\x06proto3"
...
var file_storage_v1_file_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_storage_v1_file_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
func file_storage_v1_file_proto_init() {
	...
	file_storage_v1_file_proto_msgTypes[2].OneofWrappers = []any{
		(*GetFileRequest_Id)(nil),
	}
	file_storage_v1_file_proto_msgTypes[4].OneofWrappers = []any{}
	file_storage_v1_file_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_storage_v1_file_proto_enumTypes,
