...
// 	protoc        (unknown)
// source: permission/v1/user_role.proto
...
func (UserRole_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_permission_v1_user_role_proto_enumTypes[0].Descriptor()
}

func (UserRole_Status) Type() protoreflect.EnumType {
	return &file_permission_v1_user_role_proto_enumTypes[0]
}
...
func (UserRole_Status) EnumDescriptor() ([]byte, []int) {
	return file_permission_v1_user_role_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UserRole) Reset() {
	*x = UserRole{}
	mi := &file_permission_v1_user_role_proto_msgTypes[0]
...
func (*UserRole) Descriptor() ([]byte, []int) {
	return file_permission_v1_user_role_proto_rawDescGZIP(), []int{0}
}
...
var File_permission_v1_user_role_proto protoreflect.FileDescriptor

const file_permission_v1_user_role_proto_rawDesc = "" +
	"\n" +
	"\x1dpermission/v1/user_role.proto\x12\x15permission.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17identity/v1/types.proto\"\xd8\v\n" +
	"\bUserRole\x12\x1d\n" +
	...
	"\v_created_atB\r\n" +
	"\v_updated_atB\r\n" +
	"\v_deleted_atB\xca\x01\n" +
	"\x19com.permission.service.v1B\rUserRoleProtoP\x01Z(admin/api/gen/permission/v1;permissionv1\xa2\x02\x03PSX\xaa\x02\x15Permission.Service.V1\xca\x02\x15Permission\\Service\\V1\xe2\x02!Permission\\Service\\V1\\GPBMetadata\xea\x02\x17Permission::Service::V1b\x06proto3"

var (
	file_permission_v1_user_role_proto_rawDescOnce sync.Once
	file_permission_v1_user_role_proto_rawDescData []byte
)

func file_permission_v1_user_role_proto_rawDescGZIP() []byte {
	file_permission_v1_user_role_proto_rawDescOnce.Do(func() {
		file_permission_v1_user_role_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_permission_v1_user_role_proto_rawDesc), len(file_permission_v1_user_role_proto_rawDesc)))
	})
	return file_permission_v1_user_role_proto_rawDescData
}

var file_permission_v1_user_role_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_permission_v1_user_role_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_permission_v1_user_role_proto_goTypes = []any{
...
var file_permission_v1_user_role_proto_depIdxs = []int32{
...
func init() { file_permission_v1_user_role_proto_init() }
func file_permission_v1_user_role_proto_init() {
	if File_permission_v1_user_role_proto != nil {
		return
	}
	file_permission_v1_user_role_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_permission_v1_user_role_proto_rawDesc), len(file_permission_v1_user_role_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_permission_v1_user_role_proto_goTypes,
		DependencyIndexes: file_permission_v1_user_role_proto_depIdxs,
		EnumInfos:         file_permission_v1_user_role_proto_enumTypes,
		MessageInfos:      file_permission_v1_user_role_proto_msgTypes,
	}.Build()
	File_permission_v1_user_role_proto = out.File
	file_permission_v1_user_role_proto_goTypes = nil
	file_permission_v1_user_role_proto_depIdxs = nil
}
