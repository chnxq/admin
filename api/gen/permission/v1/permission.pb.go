...
func (Permission_Status) EnumDescriptor() ([]byte, []int) {
	return file_permission_v1_permission_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_permission_v1_permission_proto_rawDesc = "" +
	"\n" +
	"\x1epermission/v1/permission.proto\x12\x15permission.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\x93\t\n" +
	"\n" +
	"Permission\x12&\n" +
	...
	"\x0fSyncPermissions\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x00B\xcc\x01\n" +
	"\x19com.permission.service.v1B\x0fPermissionProtoP\x01Z(admin/api/gen/permission/v1;permissionv1\xa2\x02\x03PSX\xaa\x02\x15Permission.Service.V1\xca\x02\x15Permission\\Service\\V1\xe2\x02!Permission\\Service\\V1\\GPBMetadata\xea\x02\x17Permission::Service::V1b\x06proto3"
...
func file_permission_v1_permission_proto_init() {
	...
	file_permission_v1_permission_proto_msgTypes[4].OneofWrappers = []any{}
	file_permission_v1_permission_proto_msgTypes[5].OneofWrappers = []any{
