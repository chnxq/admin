...
// 	protoc        (unknown)
// source: permission/v1/policy_evaluation_log.proto
...
func (x *PolicyEvaluationLog) Reset() {
	*x = PolicyEvaluationLog{}
	mi := &file_permission_v1_policy_evaluation_log_proto_msgTypes[0]
...
func (*PolicyEvaluationLog) Descriptor() ([]byte, []int) {
	return file_permission_v1_policy_evaluation_log_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListPolicyEvaluationLogResponse) Reset() {
	*x = ListPolicyEvaluationLogResponse{}
	mi := &file_permission_v1_policy_evaluation_log_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPolicyEvaluationLogResponse) Descriptor() ([]byte, []int) {
	return file_permission_v1_policy_evaluation_log_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetPolicyEvaluationLogRequest) Reset() {
	*x = GetPolicyEvaluationLogRequest{}
	mi := &file_permission_v1_policy_evaluation_log_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPolicyEvaluationLogRequest) Descriptor() ([]byte, []int) {
	return file_permission_v1_policy_evaluation_log_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreatePolicyEvaluationLogRequest) Reset() {
	*x = CreatePolicyEvaluationLogRequest{}
	mi := &file_permission_v1_policy_evaluation_log_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreatePolicyEvaluationLogRequest) Descriptor() ([]byte, []int) {
	return file_permission_v1_policy_evaluation_log_proto_rawDescGZIP(), []int{3}
}
...
var File_permission_v1_policy_evaluation_log_proto protoreflect.FileDescriptor

const file_permission_v1_policy_evaluation_log_proto_rawDesc = "" +
	"\n" +
	")permission/v1/policy_evaluation_log.proto\x12\x15permission.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xf3\v\n" +
	...
	"\x06Create\x127.permission.service.v1.CreatePolicyEvaluationLogRequest\x1a\x16.google.protobuf.Empty\"\x00B\xd5\x01\n" +
	"\x19com.permission.service.v1B\x18PolicyEvaluationLogProtoP\x01Z(admin/api/gen/permission/v1;permissionv1\xa2\x02\x03PSX\xaa\x02\x15Permission.Service.V1\xca\x02\x15Permission\\Service\\V1\xe2\x02!Permission\\Service\\V1\\GPBMetadata\xea\x02\x17Permission::Service::V1b\x06proto3"

var (
	file_permission_v1_policy_evaluation_log_proto_rawDescOnce sync.Once
	file_permission_v1_policy_evaluation_log_proto_rawDescData []byte
)

func file_permission_v1_policy_evaluation_log_proto_rawDescGZIP() []byte {
	file_permission_v1_policy_evaluation_log_proto_rawDescOnce.Do(func() {
		file_permission_v1_policy_evaluation_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_permission_v1_policy_evaluation_log_proto_rawDesc), len(file_permission_v1_policy_evaluation_log_proto_rawDesc)))
	})
	return file_permission_v1_policy_evaluation_log_proto_rawDescData
}

var file_permission_v1_policy_evaluation_log_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_permission_v1_policy_evaluation_log_proto_goTypes = []any{
...
var file_permission_v1_policy_evaluation_log_proto_depIdxs = []int32{
...
func init() { file_permission_v1_policy_evaluation_log_proto_init() }
func file_permission_v1_policy_evaluation_log_proto_init() {
	if File_permission_v1_policy_evaluation_log_proto != nil {
		return
	}
	file_permission_v1_policy_evaluation_log_proto_msgTypes[0].OneofWrappers = []any{}
	file_permission_v1_policy_evaluation_log_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_permission_v1_policy_evaluation_log_proto_rawDesc), len(file_permission_v1_policy_evaluation_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_permission_v1_policy_evaluation_log_proto_goTypes,
		DependencyIndexes: file_permission_v1_policy_evaluation_log_proto_depIdxs,
		MessageInfos:      file_permission_v1_policy_evaluation_log_proto_msgTypes,
	}.Build()
	File_permission_v1_policy_evaluation_log_proto = out.File
	file_permission_v1_policy_evaluation_log_proto_goTypes = nil
	file_permission_v1_policy_evaluation_log_proto_depIdxs = nil
}
