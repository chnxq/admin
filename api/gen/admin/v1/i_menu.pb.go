...
var File_admin_v1_i_menu_proto protoreflect.FileDescriptor

const file_admin_v1_i_menu_proto_rawDesc = "" +
	"\n" +
	"\x15admin/v1/i_menu.proto\x12\x10admin.service.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a\x16resource/v1/menu.proto2\x8e\x04\n" +
	"\vMenuService\x12a\n" +
	...
	"\x06Delete\x12&.resource.service.v1.DeleteMenuRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/admin/v1/menus/{id}B\xa2\x01\n" +
	"\x14com.admin.service.v1B\n" +
	"IMenuProtoP\x01Z\x1cadmin/api/gen/admin/v1;admin\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"

var file_admin_v1_i_menu_proto_goTypes = []any{
...
var file_admin_v1_i_menu_proto_depIdxs = []int32{
...
func init() { file_admin_v1_i_menu_proto_init() }
func file_admin_v1_i_menu_proto_init() {
	if File_admin_v1_i_menu_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_v1_i_menu_proto_rawDesc), len(file_admin_v1_i_menu_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_v1_i_menu_proto_goTypes,
		DependencyIndexes: file_admin_v1_i_menu_proto_depIdxs,
	}.Build()
	File_admin_v1_i_menu_proto = out.File
	file_admin_v1_i_menu_proto_goTypes = nil
	file_admin_v1_i_menu_proto_depIdxs = nil
}
