...
// Unary RPC
func (s *redactedUserServiceServer) List(ctx context.Context, in *pagination.PagingRequest) (*identity.ListUserResponse, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Get(ctx context.Context, in *identity.GetUserRequest) (*identity.User, error) {
	if s.bypass.CheckInternal(ctx) {
...
// Unary RPC
func (s *redactedUserServiceServer) Create(ctx context.Context, in *identity.CreateUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Update(ctx context.Context, in *identity.UpdateUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) Delete(ctx context.Context, in *identity.DeleteUserRequest) (*emptypb.Empty, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) UserExists(ctx context.Context, in *identity.UserExistsRequest) (*identity.UserExistsResponse, error) {
...
// Unary RPC
func (s *redactedUserServiceServer) EditUserPassword(ctx context.Context, in *identity.EditUserPasswordRequest) (*emptypb.Empty, error) {
