...
var File_admin_v1_i_tenant_proto protoreflect.FileDescriptor

const file_admin_v1_i_tenant_proto_rawDesc = "" +
	"\n" +
	"\x17admin/v1/i_tenant.proto\x12\x10admin.service.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a\x18identity/v1/tenant.proto2\xc4\x06\n" +
	"\rTenantService\x12e\n" +
	...
	"\fTenantExists\x12(.identity.service.v1.TenantExistsRequest\x1a).identity.service.v1.TenantExistsResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/admin/v1/tenants:existsB\xa4\x01\n" +
	"\x14com.admin.service.v1B\fITenantProtoP\x01Z\x1cadmin/api/gen/admin/v1;admin\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"

var file_admin_v1_i_tenant_proto_goTypes = []any{
...
var file_admin_v1_i_tenant_proto_depIdxs = []int32{
...
func init() { file_admin_v1_i_tenant_proto_init() }
func file_admin_v1_i_tenant_proto_init() {
	if File_admin_v1_i_tenant_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_v1_i_tenant_proto_rawDesc), len(file_admin_v1_i_tenant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_v1_i_tenant_proto_goTypes,
		DependencyIndexes: file_admin_v1_i_tenant_proto_depIdxs,
	}.Build()
	File_admin_v1_i_tenant_proto = out.File
	file_admin_v1_i_tenant_proto_goTypes = nil
	file_admin_v1_i_tenant_proto_depIdxs = nil
}
