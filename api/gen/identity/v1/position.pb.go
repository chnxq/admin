...
const file_identity_v1_position_proto_rawDesc = "" +
	"\n" +
	"\x1aidentity/v1/position.proto\x12\x13identity.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xad\x13\n" +
	"\bPosition\x12#\n" +
	...
	"\x06Delete\x12*.identity.service.v1.DeletePositionRequest\x1a\x16.google.protobuf.Empty\"\x00B\xba\x01\n" +
	"\x17com.identity.service.v1B\rPositionProtoP\x01Z\"admin/api/gen/identity/v1;identity\xa2\x02\x03ISX\xaa\x02\x13Identity.Service.V1\xca\x02\x13Identity\\Service\\V1\xe2\x02\x1fIdentity\\Service\\V1\\GPBMetadata\xea\x02\x15Identity::Service::V1b\x06proto3"
...
var file_identity_v1_position_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_identity_v1_position_proto_init() {
	...
	file_identity_v1_position_proto_msgTypes[0].OneofWrappers = []any{}
	file_identity_v1_position_proto_msgTypes[2].OneofWrappers = []any{
		(*GetPositionRequest_Id)(nil),
		(*GetPositionRequest_Name)(nil),
		(*GetPositionRequest_Code)(nil),
	}
	file_identity_v1_position_proto_msgTypes[4].OneofWrappers = []any{}
	file_identity_v1_position_proto_msgTypes[5].OneofWrappers = []any{
