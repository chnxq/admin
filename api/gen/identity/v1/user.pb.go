...
func (User_Gender) EnumDescriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{0, 0}
}
...
func (User_Status) EnumDescriptor() ([]byte, []int) {
	return file_identity_v1_user_proto_rawDescGZIP(), []int{0, 1}
}
...
const file_identity_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"UserExists\x12&.identity.service.v1.UserExistsRequest\x1a'.identity.service.v1.UserExistsResponse\"\x00B\xb6\x01\n" +
	"\x17com.identity.service.v1B\tUserProtoP\x01Z\"admin/api/gen/identity/v1;identity\xa2\x02\x03ISX\xaa\x02\x13Identity.Service.V1\xca\x02\x13Identity\\Service\\V1\xe2\x02\x1fIdentity\\Service\\V1\\GPBMetadata\xea\x02\x15Identity::Service::V1b\x06proto3"
...
func file_identity_v1_user_proto_init() {
	...
	file_identity_v1_user_proto_msgTypes[3].OneofWrappers = []any{}
	file_identity_v1_user_proto_msgTypes[4].OneofWrappers = []any{}
	file_identity_v1_user_proto_msgTypes[5].OneofWrappers = []any{
		(*DeleteUserRequest_Id)(nil),
		(*DeleteUserRequest_Username)(nil),
	}
	file_identity_v1_user_proto_msgTypes[6].OneofWrappers = []any{
	...
	file_identity_v1_user_proto_msgTypes[18].OneofWrappers = []any{
