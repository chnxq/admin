...
func (Tenant_Status) EnumDescriptor() ([]byte, []int) {
	return file_identity_v1_tenant_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Tenant_Type) EnumDescriptor() ([]byte, []int) {
	return file_identity_v1_tenant_proto_rawDescGZIP(), []int{0, 1}
}
...
func (Tenant_AuditStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_identity_v1_tenant_proto_enumTypes[2].Descriptor()
}

func (Tenant_AuditStatus) Type() protoreflect.EnumType {
	return &file_identity_v1_tenant_proto_enumTypes[2]
}
...
func (Tenant_AuditStatus) EnumDescriptor() ([]byte, []int) {
	return file_identity_v1_tenant_proto_rawDescGZIP(), []int{0, 2}
}
...
const file_identity_v1_tenant_proto_rawDesc = "" +
	"\n" +
	"\x18identity/v1/tenant.proto\x12\x13identity.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1epagination/v1/pagination.proto\x1a\x16identity/v1/user.proto\"\xc1\x12\n" +
	"\x06Tenant\x12#\n" +
	...
	"\x11AssignTenantAdmin\x12-.identity.service.v1.AssignTenantAdminRequest\x1a\x16.google.protobuf.Empty\"\x00B\xb8\x01\n" +
	"\x17com.identity.service.v1B\vTenantProtoP\x01Z\"admin/api/gen/identity/v1;identity\xa2\x02\x03ISX\xaa\x02\x13Identity.Service.V1\xca\x02\x13Identity\\Service\\V1\xe2\x02\x1fIdentity\\Service\\V1\\GPBMetadata\xea\x02\x15Identity::Service::V1b\x06proto3"
...
var file_identity_v1_tenant_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_identity_v1_tenant_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
func file_identity_v1_tenant_proto_init() {
	...
	file_identity_v1_tenant_proto_msgTypes[0].OneofWrappers = []any{}
	file_identity_v1_tenant_proto_msgTypes[2].OneofWrappers = []any{
		(*GetTenantRequest_Id)(nil),
		(*GetTenantRequest_Code)(nil),
		(*GetTenantRequest_Name)(nil),
	}
	file_identity_v1_tenant_proto_msgTypes[4].OneofWrappers = []any{}
	file_identity_v1_tenant_proto_msgTypes[5].OneofWrappers = []any{
