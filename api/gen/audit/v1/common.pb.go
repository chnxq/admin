...
func (x *DigitalSignature) Reset() {
	*x = DigitalSignature{}
	mi := &file_audit_v1_common_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_audit_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x15audit/v1/common.proto\x12\x10audit.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\xef\x01\n" +
	...
	"\tPERMANENT\x10\x04B\xa3\x01\n" +
	"\x14com.audit.service.v1B\vCommonProtoP\x01Z\x1cadmin/api/gen/audit/v1;audit\xa2\x02\x03ASX\xaa\x02\x10Audit.Service.V1\xca\x02\x10Audit\\Service\\V1\xe2\x02\x1cAudit\\Service\\V1\\GPBMetadata\xea\x02\x12Audit::Service::V1b\x06proto3"

var (
	file_audit_v1_common_proto_rawDescOnce sync.Once
	file_audit_v1_common_proto_rawDescData []byte
)

func file_audit_v1_common_proto_rawDescGZIP() []byte {
	file_audit_v1_common_proto_rawDescOnce.Do(func() {
		file_audit_v1_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_audit_v1_common_proto_rawDesc), len(file_audit_v1_common_proto_rawDesc)))
	})
	return file_audit_v1_common_proto_rawDescData
}

var file_audit_v1_common_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_audit_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_audit_v1_common_proto_goTypes = []any{
...
func file_audit_v1_common_proto_init() {
	...
	file_audit_v1_common_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_audit_v1_common_proto_rawDesc), len(file_audit_v1_common_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
