...
// 	protoc        (unknown)
// source: audit/v1/operation_audit_log.proto
...
func (OperationAuditLog_ActionType) Descriptor() protoreflect.EnumDescriptor {
	return file_audit_v1_operation_audit_log_proto_enumTypes[0].Descriptor()
}

func (OperationAuditLog_ActionType) Type() protoreflect.EnumType {
	return &file_audit_v1_operation_audit_log_proto_enumTypes[0]
}
...
func (OperationAuditLog_ActionType) EnumDescriptor() ([]byte, []int) {
	return file_audit_v1_operation_audit_log_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OperationAuditLog) Reset() {
	*x = OperationAuditLog{}
	mi := &file_audit_v1_operation_audit_log_proto_msgTypes[0]
...
func (*OperationAuditLog) Descriptor() ([]byte, []int) {
	return file_audit_v1_operation_audit_log_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListOperationAuditLogResponse) Reset() {
	*x = ListOperationAuditLogResponse{}
	mi := &file_audit_v1_operation_audit_log_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListOperationAuditLogResponse) Descriptor() ([]byte, []int) {
	return file_audit_v1_operation_audit_log_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetOperationAuditLogRequest) Reset() {
	*x = GetOperationAuditLogRequest{}
	mi := &file_audit_v1_operation_audit_log_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOperationAuditLogRequest) Descriptor() ([]byte, []int) {
	return file_audit_v1_operation_audit_log_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateOperationAuditLogRequest) Reset() {
	*x = CreateOperationAuditLogRequest{}
	mi := &file_audit_v1_operation_audit_log_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateOperationAuditLogRequest) Descriptor() ([]byte, []int) {
	return file_audit_v1_operation_audit_log_proto_rawDescGZIP(), []int{3}
}
...
var File_audit_v1_operation_audit_log_proto protoreflect.FileDescriptor

const file_audit_v1_operation_audit_log_proto_rawDesc = "" +
	"\n" +
	"\"audit/v1/operation_audit_log.proto\x12\x10audit.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a\x15audit/v1/common.proto\x1a\x1baudit/v1/geo_location.proto\"\xee\x0e\n" +
	...
	"\x06Create\x120.audit.service.v1.CreateOperationAuditLogRequest\x1a\x16.google.protobuf.Empty\"\x00B\xae\x01\n" +
	"\x14com.audit.service.v1B\x16OperationAuditLogProtoP\x01Z\x1cadmin/api/gen/audit/v1;audit\xa2\x02\x03ASX\xaa\x02\x10Audit.Service.V1\xca\x02\x10Audit\\Service\\V1\xe2\x02\x1cAudit\\Service\\V1\\GPBMetadata\xea\x02\x12Audit::Service::V1b\x06proto3"

var (
	file_audit_v1_operation_audit_log_proto_rawDescOnce sync.Once
	file_audit_v1_operation_audit_log_proto_rawDescData []byte
)

func file_audit_v1_operation_audit_log_proto_rawDescGZIP() []byte {
	file_audit_v1_operation_audit_log_proto_rawDescOnce.Do(func() {
		file_audit_v1_operation_audit_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_audit_v1_operation_audit_log_proto_rawDesc), len(file_audit_v1_operation_audit_log_proto_rawDesc)))
	})
	return file_audit_v1_operation_audit_log_proto_rawDescData
}

var file_audit_v1_operation_audit_log_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_audit_v1_operation_audit_log_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_audit_v1_operation_audit_log_proto_goTypes = []any{
...
var file_audit_v1_operation_audit_log_proto_depIdxs = []int32{
...
func init() { file_audit_v1_operation_audit_log_proto_init() }
func file_audit_v1_operation_audit_log_proto_init() {
	if File_audit_v1_operation_audit_log_proto != nil {
		return
	}
	file_audit_v1_common_proto_init()
	file_audit_v1_geo_location_proto_init()
	file_audit_v1_operation_audit_log_proto_msgTypes[0].OneofWrappers = []any{}
	file_audit_v1_operation_audit_log_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_audit_v1_operation_audit_log_proto_rawDesc), len(file_audit_v1_operation_audit_log_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_audit_v1_operation_audit_log_proto_goTypes,
		DependencyIndexes: file_audit_v1_operation_audit_log_proto_depIdxs,
		EnumInfos:         file_audit_v1_operation_audit_log_proto_enumTypes,
		MessageInfos:      file_audit_v1_operation_audit_log_proto_msgTypes,
	}.Build()
	File_audit_v1_operation_audit_log_proto = out.File
	file_audit_v1_operation_audit_log_proto_goTypes = nil
	file_audit_v1_operation_audit_log_proto_depIdxs = nil
}
