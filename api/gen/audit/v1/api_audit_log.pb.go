...
// 	protoc        (unknown)
// source: audit/v1/api_audit_log.proto
...
func (x *ApiAuditLog) Reset() {
	*x = ApiAuditLog{}
	mi := &file_audit_v1_api_audit_log_proto_msgTypes[0]
...
func (*ApiAuditLog) Descriptor() ([]byte, []int) {
	return file_audit_v1_api_audit_log_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListApiAuditLogResponse) Reset() {
	*x = ListApiAuditLogResponse{}
	mi := &file_audit_v1_api_audit_log_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListApiAuditLogResponse) Descriptor() ([]byte, []int) {
	return file_audit_v1_api_audit_log_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetApiAuditLogRequest) Reset() {
	*x = GetApiAuditLogRequest{}
	mi := &file_audit_v1_api_audit_log_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetApiAuditLogRequest) Descriptor() ([]byte, []int) {
	return file_audit_v1_api_audit_log_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateApiAuditLogRequest) Reset() {
	*x = CreateApiAuditLogRequest{}
	mi := &file_audit_v1_api_audit_log_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateApiAuditLogRequest) Descriptor() ([]byte, []int) {
	return file_audit_v1_api_audit_log_proto_rawDescGZIP(), []int{3}
}
...
var File_audit_v1_api_audit_log_proto protoreflect.FileDescriptor

const file_audit_v1_api_audit_log_proto_rawDesc = "" +
	"\n" +
	"\x1caudit/v1/api_audit_log.proto\x12\x10audit.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17validate/validate.proto\x1a\x1epagination/v1/pagination.proto\x1a\x1baudit/v1/geo_location.proto\x1a\x1aaudit/v1/device_info.proto\"\xcc\x15\n" +
	"\vApiAuditLog\x12/\n" +
	...
	"\x06Create\x12*.audit.service.v1.CreateApiAuditLogRequest\x1a\x16.google.protobuf.Empty\"\x00B\xa8\x01\n" +
	"\x14com.audit.service.v1B\x10ApiAuditLogProtoP\x01Z\x1cadmin/api/gen/audit/v1;audit\xa2\x02\x03ASX\xaa\x02\x10Audit.Service.V1\xca\x02\x10Audit\\Service\\V1\xe2\x02\x1cAudit\\Service\\V1\\GPBMetadata\xea\x02\x12Audit::Service::V1b\x06proto3"

var (
	file_audit_v1_api_audit_log_proto_rawDescOnce sync.Once
	file_audit_v1_api_audit_log_proto_rawDescData []byte
)

func file_audit_v1_api_audit_log_proto_rawDescGZIP() []byte {
	file_audit_v1_api_audit_log_proto_rawDescOnce.Do(func() {
		file_audit_v1_api_audit_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_audit_v1_api_audit_log_proto_rawDesc), len(file_audit_v1_api_audit_log_proto_rawDesc)))
	})
	return file_audit_v1_api_audit_log_proto_rawDescData
}

var file_audit_v1_api_audit_log_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_audit_v1_api_audit_log_proto_goTypes = []any{
...
var file_audit_v1_api_audit_log_proto_depIdxs = []int32{
...
func init() { file_audit_v1_api_audit_log_proto_init() }
func file_audit_v1_api_audit_log_proto_init() {
	if File_audit_v1_api_audit_log_proto != nil {
		return
	}
	file_audit_v1_geo_location_proto_init()
	file_audit_v1_device_info_proto_init()
	file_audit_v1_api_audit_log_proto_msgTypes[0].OneofWrappers = []any{}
	file_audit_v1_api_audit_log_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_audit_v1_api_audit_log_proto_rawDesc), len(file_audit_v1_api_audit_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_audit_v1_api_audit_log_proto_goTypes,
		DependencyIndexes: file_audit_v1_api_audit_log_proto_depIdxs,
		MessageInfos:      file_audit_v1_api_audit_log_proto_msgTypes,
	}.Build()
	File_audit_v1_api_audit_log_proto = out.File
	file_audit_v1_api_audit_log_proto_goTypes = nil
	file_audit_v1_api_audit_log_proto_depIdxs = nil
}
